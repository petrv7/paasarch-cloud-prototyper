...
namespace CloudPrototyper.NET.Core.v31.Functions.Templates.Functions {
    ...
    public partial class CosmosDbFunctionTemplate : CosmosDbFunctionTemplateBase {
        ...
        private CloudPrototyper.NET.Core.v31.Functions.Generators.Functions.CosmosDbFunctionGenerator _ModelField;
        
        public CloudPrototyper.NET.Core.v31.Functions.Generators.Functions.CosmosDbFunctionGenerator Model {
            get {
        ...
        public virtual void Initialize() {
            if ((this.Errors.HasErrors == false)) {
                if (((this.Session != null) 
                    ...
                    if (typeof(CloudPrototyper.NET.Core.v31.Functions.Generators.Functions.CosmosDbFunctionGenerator).IsAssignableFrom(data.GetType())) {
                        this._ModelField = ((CloudPrototyper.NET.Core.v31.Functions.Generators.Functions.CosmosDbFunctionGenerator)(data));
                    }
                    else {
                        this.Error("The type \'CloudPrototyper.NET.Core.v31.Functions.Generators.Functions.CosmosDbFun" +
